...
vfieldtemp=np.load('sigma0_0_499.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('sigma0_500_999.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('sigma0_1000_1499.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('sigma0_1500_2068.npy')
vfield=vfield+vfieldtemp
