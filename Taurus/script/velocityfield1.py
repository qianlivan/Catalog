...
vfieldtemp=np.load('velocity1_0_499.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('velocity1_500_999.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('velocity1_1000_1499.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('velocity1_1500_2068.npy')
vfield=vfield+vfieldtemp
