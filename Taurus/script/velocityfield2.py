...
vfieldtemp=np.load('velocity2_0_499.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('velocity2_500_999.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('velocity2_1000_1499.npy')
vfield=vfield+vfieldtemp
vfieldtemp=np.load('velocity2_1500_2068.npy')
vfield=vfield+vfieldtemp
